...
extension ISO_8601.Parse.Duration {
...
extension ISO_8601.Parse.Duration: Parser.`Protocol` {
    public typealias ParseOutput = Output
    public typealias Failure = ISO_8601.Parse.Duration<Input>.Error
